    ...
    <main>
      <div className="p-10 flex gap-4  ">
        <img src={Logo} className="h-96   " alt="firstImg" />
          <div className="p-4">
               <p className="text-6xl font-extrabold h-40 text-center">Rewards for paying credit card bills.</p>
      ...
      <div className="h-5/6 flex justify-between border sticky">
            <div className="w-3/5">
                <p className="text-6xl font-extrabold p-5">feel special more often.</p>
                <p className="text-3xl font-bold pl-6 py-1">exclusive rewards for paying your bills.</p>
                <p className="text-xl font-semibold pl-6 w-3/4 py-5">every time you pay your credit card bills on CRED, you receive CRED coins. you can use these to win exclusive rewards or get special access to curated products and experiences.</p>
      ...
      <div className="h-60 border sticky">
          <div className="text-center">
            ...
            <p className="text-3xl font-extrabold px-8 py-5">rewards from brands you love.</p>
          </div>
      </div>
      <div>
